-- I manually defined the table structure (DDL) to match the CSV headers,
-- which prevented errors related to mismatched data types—a common issue when importing 'dirty' datasets.
